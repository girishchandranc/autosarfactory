...
class LoadModelsDialog(tk.Toplevel):
    ...
    def _create_widgets(self):
        ...
        self.add_folder_btn = ttk.Button(button_frame, text="Add Folder(s)...", command=self._add_folder)
...
class Application(tk.Frame):
    ...
    def __initialize_ui(self):
        ...
        self.__asr_explorer_menu.add_command(label='Generate Graph', command=self.__generate_graph)
    ...
    def __generate_graph(self):
        ...
        if item != '' and int(item) in self.__asr_explorer_id_to_node_dict:
            ...
            if filepath:
                graph_gen.create_graph_report(node, output_filename= filepath)
